...
weight_cols = np.array([40,41,42,43])
...
combined_demo_headers = np.asarray(combined_demo_headers)

np.save("demographic_data_2013-1014", combined_demo)
np.save("demographic_column_headers_2013-2014", combined_demo_headers)
np.save("seqn_demographic_2013-1014", seqn)
np.save("weights_demographic_2013-1014", weights)
